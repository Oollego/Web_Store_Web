...
<div class="col s2 l3">
          ...
          <div class="basket_baner_sale_baner">
            <a>
              <img src="img/board/3391023.webp">
            </a>
          </div>
          <div class="basket_baner_sale_baner">
            <a>
              <img src="img/board/3314849.webp">
            </a>
          </div>
        </div>
    ...
    <div class="col s10 l9">
        <?php if ($basketItems != null) { ?>
            ...
            <div class="totalBasketDiv col s12 m4 offset-m8">
                ...
                <a href="/checkout" class="waves-effect waves-light btn orange darken-3">Оформити замовлення</a>
            </div>
        <?php
